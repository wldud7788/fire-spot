  ...
  return (
    <div className="w-full border-b-2 border-[#D9D9D9] py-[14px]">
      <div className="flex items-start">
        <div className="left_area flex w-full max-w-[70%] items-center gap-[20px] pr-[15px] max-767:max-w-[calc(100%-80px)]">
          ...
          <Link
            href={SERVER_PAGE_URL.chatRoom(chatRoom.id)}
            className="w-[calc(100%-94px)] max-767:w-[calc(100%-70px)]"
          >
            ...
            <div className="flex items-center justify-start gap-[3px]">
              ...
              {chatAttendee.is_pin && (
                <button
                  className="rounded-[6px] border border-[#D9D9D9] bg-[#D9D9D9] px-[5px] py-[3px] text-[11px] text-[#737373] max-1280:px-[8px] max-1280:py-[2px]"
              ...
              {!chatAttendee.is_pin && (
                <button
                  className="rounded-[6px] border border-[#ff924c] bg-[#ff924c] px-[5px] py-[3px] text-[11px] text-[#fff] max-1280:px-[8px] max-1280:py-[2px]"
              ...
              <button
                className="rounded-[6px] border border-[#ff924c] px-[5px] py-[3px] text-[11px] text-[#ff924c] max-1280:px-[8px] max-1280:py-[2px]"
        ...
        <div className="right_area flex w-[30%] flex-none flex-col items-end justify-end max-767:w-[80px]">
          <p className="mb-[5px] line-clamp-1 w-[71px] text-right text-[14px] text-[#787878] max-767:text-[12px]">
            {formatDate_6(chatMessage?.created_at) || ""}
          </p>
          <p
            className={`${unreadCount ? "bg-main" : "bg-[#d9d9d9]"} rounded-[16px] px-[10px] py-[4px] text-center text-[18px] font-medium text-white max-1280:text-[14px] max-767:px-[8px] max-767:py-[2px] max-767:text-[12px]`}
          >
            {unreadCount}
          </p>
        </div>
